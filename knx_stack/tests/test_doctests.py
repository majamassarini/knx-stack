...
tests.append(doctest.DocTestSuite(knx_stack.encode.knxnet_ip.core.disconnect.res))
...
tests.append(doctest.DocTestSuite(knx_stack.decode.knxnet_ip.core.disconnect.req))
