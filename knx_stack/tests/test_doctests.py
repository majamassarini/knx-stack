...
tests.append(doctest.DocTestSuite(knx_stack.encode.layer.application.a_group_value_read.req))
tests.append(doctest.DocTestSuite(knx_stack.encode.layer.application.a_group_value_write.req))
tests.append(doctest.DocTestSuite(knx_stack.encode.layer.application.a_property_value_read.req))
tests.append(doctest.DocTestSuite(knx_stack.encode.layer.application.a_property_value_write.req))
tests.append(doctest.DocTestSuite(knx_stack.encode.layer.transport.t_connect.req))
tests.append(doctest.DocTestSuite(knx_stack.decode.usb_hid.report_header.report_identifier))
...
tests.append(doctest.DocTestSuite(knx_stack.decode.layer.application.a_group_value_read.ind))
tests.append(doctest.DocTestSuite(knx_stack.decode.layer.application.a_group_value_read.con))
tests.append(doctest.DocTestSuite(knx_stack.decode.layer.application.a_group_value_write.ind))
tests.append(doctest.DocTestSuite(knx_stack.decode.layer.application.a_group_value_write.con))
tests.append(doctest.DocTestSuite(knx_stack.decode.layer.application.a_property_value_read.ind))
tests.append(doctest.DocTestSuite(knx_stack.decode.layer.application.a_property_value_read.con))
tests.append(doctest.DocTestSuite(knx_stack.decode.layer.application.a_property_value_write.ind))
tests.append(doctest.DocTestSuite(knx_stack.decode.layer.application.a_property_value_write.con))
